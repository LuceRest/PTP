...
csvFile = open('6th Meet (Wednesday, March, 16th 2022)\Task\Data\GoTo_Stemming.csv', 'a')
csvWriter = csv.writer(csvFile)

    
with codecs.open('6th Meet (Wednesday, March, 16th 2022)\Task\Data\GoTo_Filtering.csv', 'r',"utf-8") as f:
    for line in f:
        # print(line)
