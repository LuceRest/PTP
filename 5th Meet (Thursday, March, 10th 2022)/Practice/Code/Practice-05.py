#read data dan membuat kolom pada dataframe

import pandas as pd
import csv

# file = 'datatweet.csv'
file = '5th Meet (Thursday, March, 10th 2022)\Practice\Data\motogpmandalika_clean.csv'
...
#penghapusan karakter dan stemming
import re,string
...
#pemodelan data menggunakan naive bayes classifier
